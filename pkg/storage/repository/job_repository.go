...
type JobRepository interface {
	...
	AckJob(ctx context.Context, jobID, agentID string, leaseExpiresAt *time.Time) error
	RenewLease(ctx context.Context, jobID, agentID string, leaseExpiresAt *time.Time) error
